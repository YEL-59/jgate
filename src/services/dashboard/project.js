...
export const getProjectDetails = async (token, id) => {
    try {
        const res = await fetch(`https://jgate2000.thesyndicates.team/api/admin/project/show/${id}`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${token}`
...
export const updateProject = async (token, id, data) => {
    try {
        ...
        const res = await fetch(`https://jgate2000.thesyndicates.team/api/admin/project/update/${id}`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${token}`
...
export const deleteProject = async (token, id) => {
    try {
        const res = await fetch(`https://jgate2000.thesyndicates.team/api/admin/project/delete/${id}`, {
...
export const getSceneDetails = async (token, id) => {
    try {
        const res = await fetch(`https://jgate2000.thesyndicates.team/api/admin/scene/show/${id}`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${token}`
...
export const deleteScene = async (token, id) => {
    try {
        const res = await fetch(`https://jgate2000.thesyndicates.team/api/admin/scene/delete/${id}`, {
