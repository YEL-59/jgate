...
export const getSubAdmins = async (token) => {
  try {
    const res = await fetch(`${apiConfig.baseURL}/sub-admin`, {
      method: "GET",
      headers: {
...
export const createSubAdmin = async (token, data) => {
  try {
    ...
    const res = await fetch(`${apiConfig.baseURL}/sub-admin/create`, {
      method: "POST",
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
export const updateSubAdminStatus = async (token, adminId) => {
  try {
    const res = await fetch(
      `${apiConfig.baseURL}/sub-admin/staus-update/${adminId}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const updateSubAdminPermissions = async (token, roleId, permissions) => {
  try {
    ...
    const res = await fetch(
      `${apiConfig.baseURL}/sub-admin/permission-update/${roleId}`,
      {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
...
export const updateSubAdminRoles = async (token, adminId, roles) => {
  try {
    ...
    const res = await fetch(
      `${apiConfig.baseURL}/sub-admin/role-update/${adminId}`,
      {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
...
export const deleteSubAdmin = async (token, adminId) => {
  try {
    const res = await fetch(
      `${apiConfig.baseURL}/sub-admin/delete/${adminId}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
...
export const getSubAdminDetails = async (token, adminId) => {
  try {
    const res = await fetch(`${apiConfig.baseURL}/sub-admin/show/${adminId}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export const getAvailablePermissions = async (token) => {
  try {
    const res = await fetch(`${apiConfig.baseURL}/sub-admin/permissions`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export const updateSubAdmin = async (token, adminId, data) => {
  try {
    ...
    const res = await fetch(
      `${apiConfig.baseURL}/sub-admin/update/${adminId}`,
      {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
