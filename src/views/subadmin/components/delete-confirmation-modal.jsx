...
export function DeleteConfirmationModal({ open, onOpenChange, onConfirm, itemName }) {
  return (
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription style={{ fontSize: '14px', color: '#666666', marginTop: '8px' }}>
            Are you sure you want to delete <strong>{itemName}</strong>? This action cannot be undone and will remove all associated access.
          </DialogDescription>
        </DialogHeader>
