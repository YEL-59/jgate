...
export function DeleteMovieModal({ open, onOpenChange, onConfirm, itemName }) {
  return (
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription style={{ fontSize: '14px', color: '#666666', marginTop: '8px' }}>
            Are you sure you want to delete <strong>{itemName}</strong> from the movie library? This action cannot be undone.
          </DialogDescription>
        </DialogHeader>
